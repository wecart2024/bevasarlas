...
//var keres = document.getElementById("keres");

//keres.addEventListener("click", function() {
    //var input = keres.querySelector("input2");
...
function toggleSearchForm() {
    var keres = document.getElementById('keres');
    if (keres.style.display === 'none') {
        keres.style.display = 'block';
    } else {
        keres.style.display = 'none';
    }
  }